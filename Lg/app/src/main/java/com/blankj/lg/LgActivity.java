...
public class LgActivity extends AppCompatActivity
    ...
    private int     consoleFilter = Lg.V;
    private int     fileFilter    = Lg.V;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_log_with_tag:
                Lg.v("customTag", "verbose");
                Lg.d("customTag", "debug");
                Lg.i("customTag", "info");
                Lg.w("customTag", "warn");
                Lg.e("customTag", "error");
                Lg.a("customTag", "assert");
                break;
            ...
            case R.id.btn_log_many_params:
                Lg.v("customTag", "verbose0", "verbose1");
                Lg.d("customTag", "debug0", "debug1");
                Lg.i("customTag", "info0", "info1");
                Lg.w("customTag", "warn0", "warn1");
                Lg.e("customTag", "error0", "error1");
                Lg.a("customTag", "assert0", "assert1");
                break;
            ...
            case R.id.btn_log_file:
                for (int i = 0; i < 100; i++) {
                    Lg.file("test0 log to file");
                    Lg.file(Lg.I, "test0 log to file");
                }
                break;
    ...
    private void updateAbout(int args) {
        switch (args) {
            ...
            case UPDATE_CONSOLE_FILTER:
                consoleFilter = consoleFilter == Lg.V ? Lg.W : Lg.V;
                break;
            case UPDATE_FILE_FILTER:
                fileFilter = fileFilter == Lg.V ? Lg.I : Lg.V;
                break;
        }
        Lg.config(this).setLogSwitch(log)
        ...
        tvAboutLog.setText(Lg.getConfig());
    }

    private String getDir() {
        return Lg.getConfig().split(System.getProperty("line.separator"))[5].substring(5);
    }
